...
const crypto = require('crypto'); // crypto模块提供了加密解密功能 http://nodejs.cn/api/crypto.html#crypto
...
fs.createReadStream(file)
  ...
  .pipe(crypto.createCipheriv('aes-128-cbc', '1234567890123456', '1234567890123456')) // 加密 第一个参数为加密算法,第二个为加密密钥,第三个为初始向量  http://nodejs.cn/api/crypto.html#cryptocreatecipherivalgorithm-key-iv-options
  .pipe(req)
  .on("finish", () => {
