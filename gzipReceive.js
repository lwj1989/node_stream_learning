...
const server = http.createServer((req, res) => {
  ...
  req
  .pipe(crypto.createDecipheriv('aes-128-cbc', '1234567890123456', '1234567890123456')) // 解密 第一个参数为加密算法,第二个为加密密钥,第三个为初始向量  http://nodejs.cn/api/crypto.html#cryptocreatedecipherivalgorithm-key-iv-options
